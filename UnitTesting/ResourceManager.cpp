...
double ConcreteManager::getConcreteCap() const {
    return concreteCap;
}
...
double WaterManager::getWaterCap() const {
    return waterCap;
}

double WaterManager::getInitialWaterCap() const {
    return initialWaterCap;
}

bool WaterManager::getReserve() const {
    return reserve;
}
...
void WaterManager::setReserve(bool reserve) {
...
double PowerManager::getPowerCap() const {
    return powerCap;
}

double PowerManager::getInitialPowerCap() const {
    return initialPowerCap;
}

bool PowerManager::getReserve() const {
    return reserve;
}

void::PowerManager::setReserve(bool reserve) {
    this->reserve = reserve;
}
